...
export default async function Persistance() {
  ...
  return (
    <>
      ...
      <Paragraph>
        <StyledLink href="https://github.com/hipstersmoothie/window-splitter/blob/main/packages/docs/src/app/docs/examples/persistance/PersistanceExample.tsx">
          See the source code
        </StyledLink>
      </Paragraph>
      ...
      <Paragraph>
        <StyledLink href="https://github.com/hipstersmoothie/window-splitter/blob/main/packages/docs/src/app/docs/examples/persistance/PersistanceCookieExample.tsx">
          See the source code
        </StyledLink>
      </Paragraph>
    </>
